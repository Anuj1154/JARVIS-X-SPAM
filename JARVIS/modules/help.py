...
HELP_STRING = f"★ Monster ʙᴏᴛs ʜᴇʟᴘ ᴍᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @MONSTER_TERA_BAAP1**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 •", "https://t.me/monster_king_is_here"),
      Button.url("• 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 •", "https://t.me/monster_discussion")
    ]
  ]
